...
print("le temps d'encodage des chromosomes = ",TraitementDeDonnees.temps_encod)
print("le temps d'execution de l'AG séquentiel = ",ag.temps_exec)
print("le temps de calcul de la fitness exacte de tous les chromosomes = ",TraitementDeDonnees.time)
print("--------------------------------------------------------------------------------")
